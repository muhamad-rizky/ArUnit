...
<div class="page-header">
    <div>
        <h1 class="page-title">Buat Asuransi</h1>
        <p class="page-subtitle">Tambahkan asuransi baru dengan cepat dan rapi.</p>
    </div>
...
<div class="bright-card">
    <form method="POST" action="{{ route('admin.asuransi.store') }}">
        @csrf
        <div class="form-grid">
