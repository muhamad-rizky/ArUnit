...
<div class="page-header">
    <div>
        <h1 class="page-title">Edit Warna</h1>
        <p class="page-subtitle">Perbarui informasi Warna dengan cepat dan mudah.</p>
    </div>
...
<div class="bright-card">
    <form method="POST" action="{{ route('admin.warnas.update', $item) }}">
        @csrf @method('PUT')
        <div class="form-grid">
