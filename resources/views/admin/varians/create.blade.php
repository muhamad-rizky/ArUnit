...
<div class="page-header">
    <div>
        <h1 class="page-title">Buat Varian</h1>
        <p class="page-subtitle">Tambahkan Varian baru dengan cepat dan rapi.</p>
    </div>
...
<div class="bright-card">
    <form method="POST" action="{{ route('admin.varians.store') }}">
        @csrf
        <div class="form-grid">
