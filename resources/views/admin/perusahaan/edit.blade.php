...
<div class="page-header">
    <div>
        ...
        <p class="page-subtitle">Perbarui informasi perusahaan dengan cepat dan mudah.</p>
    </div>
...
<div class="bright-card">
    <form method="POST" action="{{ route('admin.perusahaan.update', $item) }}">
        @csrf @method('PUT')
        <div class="form-grid">
            ...
            <div class="form-group full-width">
                ...
                <input
                    ...
                    class="form-input"
                    min="1"
                    value="{{ old('overdue', $item->overdue ?? 28) }}"
                    required>
            </div>
        </div>
